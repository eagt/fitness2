...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post measurements_url, params: { measurement: { date: @measurement.date, fat_pct: @measurement.fat_pct, user_id: @measurement.user_id, weight: @measurement.weight, weight_unit: @measurement.weight_unit } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: { measurement: { date: @measurement.date, fat_pct: @measurement.fat_pct, user_id: @measurement.user_id, weight: @measurement.weight, weight_unit: @measurement.weight_unit } }
